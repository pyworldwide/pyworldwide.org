...
const footerLinks = {
  community: [
    { name: "Join Us", href: "https://app.youform.com/forms/0cvg3fws" },
    { name: "Contribute", href: "https://github.com/pyworldwide" },
    { name: "Core Values", href: "https://www.python.org/psf/mission/" },
  ...
  about: [
    ...
    { name: "Our Mission", href: "https://www.python.org/psf/mission/" },
    { name: "Quotes", href: "https://www.python.org/about/quotes/" },
  ],
  social: [
      ...
      <div className="container mx-auto px-4 py-8 md:py-12">
        ...
        <div className="border-t-2 border-black pt-4 md:pt-6 flex flex-col md:flex-row justify-between items-center gap-4 text-center md:text-left">
          ...
          <div className="flex gap-4 md:gap-6">
            ...
            <Link href="https://x.com/pyworldwide" className="hover:scale-110 transition-transform">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
